...
class LanguageProvider extends ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'vi': {
      ...
      'landing.hero.subtitle': 'Tìm trạm sạc xe điện gần bạn với AI. Đặt chỗ trước, so sánh giá, theo dõi thời gian thực.',
    ...
    'en': {
      ...
      'landing.hero.subtitle': 'Find EV charging stations near you with AI. Book ahead, compare prices, real-time tracking.',
